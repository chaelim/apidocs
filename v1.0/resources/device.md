...
|objectId|String|The unique identifier for the device. Inherited from [DirectoryObject](directoryobject.md). Key, Not nullable. Read-only.|
|objectType|String|A string that identifies the object type. For devices the value is always “Device”. |
